...
import type { UseInteriorTabWorkflowsResult } from './use_interior_tab_workflows.js';

export function createInteriorLayoutSectionProps(
  ...
  return {
    ...
    isSketchDivisionToolActive: state.isSketchDivisionToolActive,
    ...
    showShelfVariantControls: state.showShelfVariantControls,
    ...
    enterSketchDivision: workflows.enterSketchDivision,
