...
import { clamp, getLightBounds } from './settings_visual_shared_lighting.js';
import type {
  ActionTileProps,
  FloorStyleSwatchProps,
  LightSliderProps,
} from './settings_visual_sections_contracts.js';
import { handleSyntheticButtonKeyDown } from './settings_visual_sections_shared.js';
