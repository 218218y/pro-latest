...
import type { SettingsVisualLightingSectionModel } from './use_settings_visual_controller_contracts.js';
import { LIGHT_PRESET_OPTIONS } from './settings_visual_sections_contracts.js';
import { ActionTile, LightSlider } from './settings_visual_sections_controls.js';

export function SettingsVisualLightingSection(props: {
  model: SettingsVisualLightingSectionModel;
}): ReactElement {
