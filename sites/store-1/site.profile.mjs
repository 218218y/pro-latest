// WardrobePro site profile: חנות 1
//
...
export default {
  ...
  supabase: {
    ...
    realtimeChannelPrefix: 'wp_cloud_sync_store_1',
  ...
  variants: {
    main: {
      title: 'עיצוב ארונות PRO - חנות 1',
      showRoomWidget: true,
      orderPdfTemplateUrl: 'order_template.pdf',
    },

    site2: {
      title: 'עיצוב ארונות PRO - חנות 1 לקוחות',
