...
const CASES = [
  ...
  {
    name: 'settings visual controls shared owner keeps contracts/room/lighting/interactions separated',
    owner: 'esm/native/ui/react/tabs/settings_visual_shared.ts',
    includes: [
      /settings_visual_shared_contracts\.js/,
      /settings_visual_shared_normalize\.js/,
      /settings_visual_shared_lighting\.js/,
      /settings_visual_shared_room\.js/,
      /settings_visual_shared_interactions\.js/,
    ],
    excludes: [/LIGHT_PRESETS/, /getRoomDesignData\(/, /syncGlobalClickMode\(/],
    helpers: [
      [
        'esm/native/ui/react/tabs/settings_visual_shared_contracts.ts',
        [/export type SettingsVisualFloorType/, /export const DEFAULT_WALL_COLOR/],
      ],
      [
        'esm/native/ui/react/tabs/settings_visual_shared_normalize.ts',
        [/export function normalizeFloorStyle\(/],
      ],
      [
        'esm/native/ui/react/tabs/settings_visual_shared_lighting.ts',
        [/export const LIGHT_PRESETS/, /export function getLightBounds\(/],
      ],
      ['esm/native/ui/react/tabs/settings_visual_shared_room.ts', [/export function getRoomDesignData\(/]],
      [
        'esm/native/ui/react/tabs/settings_visual_shared_interactions.ts',
        [/export function syncGlobalClickMode\(/, /export function closeInteractiveStateOnGlobalOff\(/],
      ],
    ],
  },
];
